<div class="container" style="background-color:#F5F5F5;">
    <div class="col-xs-6 col-md-6">
      <h3 style="font-family:Cooperplate Gothic Light;"><b>Classe: </b>{{curso.cla_nombre}}</h3>
    </div>
    <div class="col-xs-6 col-md-6">
      ...
      <table id="tableAlumnos" class="table table-bordered table-responsive" style="font-family:Cooperplate Gothic Light;">
        <thead>
          <tr>
            ...
            <th><a href="" ng-click="sortBy('aluclaequ_PO_acc')">PO Acu</a></th>
            ...
            <th style="text-align:center;"><a href="">Acció</a></th>
          </tr>
        </thead>
        <tbody>
