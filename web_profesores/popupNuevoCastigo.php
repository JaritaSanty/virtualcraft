    ...
    <form ng-cloak name="myForm" method="post" ng-controller="CastigosCursoController">
        <md-toolbar>
            <div class="md-toolbar-tools">
                <h2 style="font-family:Cooperplate Gothic Light;">Nou Càstig</h2>
                <span flex></span>
            ...
            <div class="md-dialog-content">
                ...
                <div class="row">
                    <div class="col-xs-2 col-md-2">
                      ...
                      <input class="form-control" ng-model="castigo.act_PV" type="number" placeholder="PV" style="font-family:Cooperplate Gothic Light;" required/>
                    </div>
                    <div class="col-xs-2 col-md-2">
                      <label style="font-family:Cooperplate Gothic Light;">PD:</label>
                      <input class="form-control" ng-model="castigo.act_PD" type="number" placeholder="PD" style="font-family:Cooperplate Gothic Light;" required/>
                    </div>
                    <div class="col-xs-2 col-md-2">
                      <label style="font-family:Cooperplate Gothic Light;">PO:</label>
                      <input class="form-control" ng-model="castigo.act_PO" type="number" placeholder="PO" style="font-family:Cooperplate Gothic Light;" required/>
                    </div>
                    <div class="col-xs-2 col-md-2">
                      <label style="font-family:Cooperplate Gothic Light;">PP:</label>
                      <input class="form-control" ng-model="castigo.act_PP" type="number" placeholder="PP" style="font-family:Cooperplate Gothic Light;" required/>
                    </div>
                    <div class="col-xs-2 col-md-2">
                      <label style="font-family:Cooperplate Gothic Light;">FO:</label>
                      <input class="form-control" ng-model="castigo.act_FO" type="number" placeholder="FO" style="font-family:Cooperplate Gothic Light;" required/>
                    </div>
                </div>
                <br/>
                <div class="row text-right">
                  <button ng-click="answer('nuevo',castigo);" class="btn btn-success" ng-disabled="myForm.$invalid">Guardar</button>
                </div>
            </div>
        </md-dialog-content>
    </form>
