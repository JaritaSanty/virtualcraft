    ...
    <form ng-cloak name="myForm" method="post" ng-controller="TrabajosCursoController">
        <md-toolbar>
            <div class="md-toolbar-tools">
                <h2 style="font-family:Cooperplate Gothic Light;">Nou Treball</h2>
                <span flex></span>
                ...
                <div class="row">
                    <div class="col-xs-2 col-md-2">
                      <label style="font-family:Cooperplate Gothic Light;">PV:</label>
                        <input class="form-control" ng-model="trabajo.tra_PV" type="number" placeholder="PV" style="font-family:Cooperplate Gothic Light;" required/>
                    </div>
                    <div class="col-xs-2 col-md-2">
                      <label style="font-family:Cooperplate Gothic Light;">PD:</label>
                      <input class="form-control" ng-model="trabajo.tra_PD" type="number" placeholder="PD" style="font-family:Cooperplate Gothic Light;" required/>
                    </div>
                    <div class="col-xs-2 col-md-2">
                    ...
                    <div class="col-xs-2 col-md-2">
                      ...
                      <input class="form-control" ng-model="trabajo.tra_FO" type="number" placeholder="FO" style="font-family:Cooperplate Gothic Light;" required/>
                    </div>
                </div>
                <br/>
                <div class="row text-right">
                  <button ng-click="answer('nuevo',trabajo);" class="btn btn-success" ng-disabled="myForm.$invalid">Guardar</button>
                </div>
            </div>
        </md-dialog-content>
    </form>
