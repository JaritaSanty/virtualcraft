...
$stmtInsert = $DBcon->prepare("INSERT INTO actuaciones (cla_id, act_nombre, act_descripcion, act_tipo, act_PV, act_PD, act_PO, act_FO)
                                      VALUES(:cla_id, :act_nombre, :act_descripcion, :act_tipo, :act_PV, :act_PD, :act_PO, :act_FO)");
