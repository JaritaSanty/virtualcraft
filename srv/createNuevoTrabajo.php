...
$stmtInsert = $DBcon->prepare("INSERT INTO trabajos (cla_id, tra_nombre, tra_descripcion, tra_PV, tra_PD, tra_PO, tra_PP, tra_FO)
                                      VALUES(:cla_id, :tra_nombre, :tra_descripcion, :tra_PV, :tra_PD, :tra_PO, :tra_PP, :tra_FO)");
...
$stmtInsert->bindParam(':tra_PP', $_POST['tra_PP'], PDO::PARAM_STR);
